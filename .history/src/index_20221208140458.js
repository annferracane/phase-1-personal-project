...
function sortJokes(jokeData) {
    ...
    const sortedJokeData = jokeData.sort(function(a, b) { 
        return a.votes - b.votes  ||  a.votes.localeCompare(b.votes);
    });
    console.log(sortedJokeData); 

    return jokeData;
}

function sortByVoites(array, key) {
