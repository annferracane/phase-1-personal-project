...
// Function calls external API, asseses data returned and calls callback functions to post to db.json and 
...
// Refresh jokes handler which calls fetchJokes function and passes two functions as callback
