...
function fetchNewJokes() {
    ...
    .then(resp => resp.json())
    .then(jokeAPIData => function buildArray(jokeAPIData) {
        console.log("logged here");
        const jokeArray = [];
        jokeAPIData.jokes.forEach(jokeAPI => function(jokeAPI) {
            return 1;
            let joke;
    ...
    .then(jokeArray => console.log("10"))
    .catch(error => console.log(`Error with joke API: ${error}`));
        //.then(jokeArray => jokeArray.forEach(joke => addJoke(joke)))
