...
const jokeCardsgGridRow = document.createElement('div');
const jokeCardsgGridCol = document.createElement('div');
jokeCardsgGridRow.className = 'row';
jokeCardsgGridCol.className = 'col';
jokeCardsgGridRow.appendChild(jokeCardsgGridCol);
jokeCardsDiv.appendChild(jokeCardsgGridRow);
