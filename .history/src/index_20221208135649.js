...
const deleteJokesBtn = document.querySelector('#reorder-jokes-btn');
...
function sortJokesBtnHandler(jokeArray) {
...
function sortJokes(jokeData) {
    return jokeData.sort(function(a, b) { 
        return a.id - b.id  ||  a.votes.localeCompare(b.votes);
    });
}
